...
* At the beginning of each turn, seeker can observe a number of squares. 
  ...
  * Otherwise, hider is not in the square, and all observed squares' probabilities are collapsed to 0%.
    * If there are adjacent non-observed squares to an observed square, the previous probability of observed square is diffused adjacent non-observed squares.
    * If there are no adjacent non-observed squares, the previous probability of observed square is diffused to all non-observed squares.
